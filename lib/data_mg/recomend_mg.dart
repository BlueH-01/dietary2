...
final Map<String, List<Map<String, dynamic>>> nutrientRecommendations = {
  "칼로리": [
    {'type': '운동', 
    'suggestion': "빠르게 걷기 30분 (약 200kcal 소모)", 
    'icon': Icons.directions_walk},
    {'type': '운동', 
    'suggestion': "집에서 할 수 있는 홈트레이닝: 스쿼트, 푸시업, 플랭크 10분", 'icon': Icons.fitness_center},
    {'type': '운동', 
...
List<Map<String, dynamic>> getRecommendations(String nutrient) {
  return nutrientRecommendations[nutrient] ?? [];
}
